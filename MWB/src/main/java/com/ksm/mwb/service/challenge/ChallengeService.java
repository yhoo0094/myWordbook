...
public class ChallengeService extends BaseService {
	...
	* @설명: 단어 목록 조회
	*/	
	public Map<String, Object> selectChalWord(StringBuilder logStr, Map<String, Object> inData) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		
		Map<String, Object> map = sqlSession.selectOne("mapper.wordbook.WordbookMapper.selectChalWord", inData);
